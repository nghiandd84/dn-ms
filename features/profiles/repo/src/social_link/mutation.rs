...
use features_profiles_entities::social_link::{
    ActiveModel, Column, Entity, Model, ModelOptionDto, SocialLinkForCreateDto, SocialLinkForUpdateDto
};
...
impl SocialLinkMutation {
    pub fn create_social_link<'a>(
        ...
        SocialLinkMutationManager::create_uuid(db, data.into())
    }
    ...
    pub fn update_social_link<'a>(
        ...
        SocialLinkMutationManager::update_by_id_uuid(db, link_id, data.into())
    }
    ...
    pub fn delete_social_link<'a>(
        ...
        SocialLinkMutationManager::delete_by_id_uuid(db, link_id)
    }
}
