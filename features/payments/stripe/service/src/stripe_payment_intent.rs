...
use features_payments_stripe_model::stripe_payment_intent::{
    StripePaymentIntentData, StripePaymentIntentForCreateRequest,
    StripePaymentIntentForUpdateRequest,
};
use features_payments_stripe_repo::stripe_payment_intent::{
    StripePaymentIntentMutation, StripePaymentIntentQuery,
};
...
impl StripePaymentIntentService {
    pub async fn create_payment_intent(
        payment_intent_request: StripePaymentIntentForCreateRequest,
    ) -> Result<Uuid, AppError> {
        let payment_intent_id =
            StripePaymentIntentMutation::create_payment_intent(payment_intent_request.into()).await;
    ...
    pub async fn bulk_create_payment_intents(
        ...
        let payment_intent_ids = StripePaymentIntentMutation::bulk_create_payment_intents(
    ...
    pub async fn update_payment_intent(
        ...
        let result = StripePaymentIntentMutation::update_payment_intent(
            payment_intent_id,
            payment_intent_request.into(),
        )
        .await;
        match result {
            ...
            Err(e) => {
                ...
                Err(AppError::Internal(
                    "Failed to update payment intent".to_string(),
                ))
            }
        }
    }
    ...
    pub async fn delete_payment_intent(payment_intent_id: Uuid) -> Result<bool, AppError> {
        ...
        match result {
            ...
            Err(e) => {
                ...
                Err(AppError::Internal(
                    "Failed to delete payment intent".to_string(),
                ))
            }
        }
    }
