...
use features_payments_core_entities::payment_method_limit::{
    ActiveModel, Column, Entity, Model, ModelOptionDto, PaymentMethodLimitForCreateDto, PaymentMethodLimitForUpdateDto,
};
...
impl PaymentMethodLimitMutation {
    pub fn create_payment_method_limit<'a>(
        ...
        PaymentMethodLimitMutationManager::create_uuid(db, data.into())
    }
    ...
    pub fn update_payment_method_limit<'a>(
        ...
        PaymentMethodLimitMutationManager::update_by_id_uuid(db, limit_id, data.into())
    }
    ...
    pub fn delete_payment_method_limit<'a>(
        ...
        PaymentMethodLimitMutationManager::delete_by_id_uuid(db, limit_id)
    }
}