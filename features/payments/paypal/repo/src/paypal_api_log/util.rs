...
use features_payments_paypal_entities::paypal_api_log::{ActiveModel, ModelOptionDto};
...
pub fn assign(mut active_model: ActiveModel, model_option: ModelOptionDto) -> ActiveModel {
    ...
    set_if_some!(active_model.paypal_request_id, model_option.paypal_request_id);
