...
use features_translation_entities::translation_key::{
    ActiveModel, Column, Entity, Model, ModelOptionDto, TranslationKeyForCreateDto, TranslationKeyForUpdateDto,
};
...
impl TranslationKeyMutation {
    pub fn create_translation_key<'a>(
        ...
        TranslationKeyMutationManager::create_uuid(db, data.into())
    }
    ...
    pub fn update_translation_key<'a>(
        ...
        TranslationKeyMutationManager::update_by_id_uuid(db, key_id, data.into())
    }
    ...
    pub fn delete_translation_key<'a>(
        ...
        TranslationKeyMutationManager::delete_by_id_uuid(db, key_id)
    }
}
