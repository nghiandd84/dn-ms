...
pub fn routes(app_state: &AppState<EmailTemplateCacheState>) -> Router {
    Router::new()
        // .route("/email-templates", post(create_client))
        // .route("/email-templates/{template_id}", patch(update_client))
        // .route("/email-templates/{template_id}", delete(delete_client))
        // .route("/email-templates/{template_id}", get(get_client))
        // .route("/email-templates", get(filter_clients))
